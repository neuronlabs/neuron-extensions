...
func (c *_Cars) InitializeCollection(_ctrl *controller.Controller) error {
...
// InitializeCollection implements database.Collection interface.
func (u *_Users) InitializeCollection(_ctrl *controller.Controller) error {
