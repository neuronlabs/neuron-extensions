...
func (a *Account) ParseFieldsStringValue(field *mapping.StructField, value string) (interface{}, error) {
	...
	case 4: // Email
		return value, nil
	case 5: // HashPassword
		return "", errors.Wrap(mapping.ErrFieldNotParser, "field 'HashPassword' doesn't have string setter.")
	case 6: // Password
		return value, nil
	}
	return nil, errors.Wrapf(mapping.ErrInvalidModelField, "provided invalid field: '%s' for given model: Account'", field.Name())
...
func (a *Account) AddRelationModel(relation *mapping.StructField, model mapping.Model) error {
	...
	default:
		return errors.Wrapf(mapping.ErrInvalidRelationField, "provided invalid relation: '%T' for the model 'Account'", model)
	}
	return nil
}
...
func (a *Account) GetRelationModelAt(relation *mapping.StructField, index int) (models mapping.Model, err error) {
	...
	case 7: // Roles
		if index > len(a.Roles)-1 {
			return nil, errors.Wrapf(mapping.ErrInvalidRelationIndex, "index out of possible range. Model: 'Account', Field Roles")
		}
...
func (a *Account) SetRelationModels(relation *mapping.StructField, models ...mapping.Model) error {
	...
	case 7: // Roles
		...
		a.Roles = temp
	default:
		return errors.Wrapf(mapping.ErrInvalidRelationField, "provided invalid relation: '%s' for the model 'Account'", relation.String())
	}
	return nil
}
...
func (a *AccountRoles) SetFieldValue(field *mapping.StructField, value interface{}) (err error) {
	...
	case 6: // AccountID
		...
		if generic, ok := value.([]interface{}); ok {
			if len(generic) > 16 {
				return errors.Wrapf(mapping.ErrFieldValue, "provided too many values for the field: 'AccountID")
			}
			for i, item := range generic {
				if v, ok := item.(byte); ok {
					a.AccountID[i] = v
...
func (a *AccountRoles) ParseFieldsStringValue(field *mapping.StructField, value string) (interface{}, error) {
	...
	case 6: // AccountID
		...
		if err := a.AccountID.UnmarshalText([]byte(value)); err != nil {
			return "", errors.Wrapf(mapping.ErrFieldValue, "invalid field 'AccountID' value: '%v' to parse string. Err: %v", a.AccountID, err)
		}
...
func (a *AccountRoles) SetRelationModel(relation *mapping.StructField, model mapping.Model) error {
	...
	case 5: // Account
		...
		return errors.Wrapf(mapping.ErrInvalidRelationValue, "provided invalid model value: '%T' for relation Account", model)
	default:
