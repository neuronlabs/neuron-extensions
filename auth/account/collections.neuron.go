...
func (a *_Accounts) InitializeCollection(_ctrl *controller.Controller) error {
...
func (a *_Accounts) AddRoles(ctx context.Context, db database.DB, model *Account, relations ...*Role) error {
	if model == nil {
...
func (a *_Accounts) ClearRolesRelation(ctx context.Context, db database.DB, models ...*Account) (int64, error) {
...
func (a *_Accounts) GetRoles(ctx context.Context, db database.DB, model *Account, relationFieldset ...string) ([]*Role, error) {
	if model == nil {
		return nil, errors.Wrap(query.ErrNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return nil, errors.Wrap(mapping.ErrFieldValue, "model's: 'Account' primary key value has zero value")
	}
	relationField, err := a.Model.RelationByIndex(7)
	if err != nil {
		return nil, err
...
func (a *_Accounts) SetRoles(ctx context.Context, db database.DB, model *Account, relations ...*Role) error {
	if model == nil {
		return errors.Wrap(query.ErrNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return errors.Wrap(mapping.ErrFieldValue, "model's: 'Account' primary key value has zero value")
	}
	relationField, err := a.Model.RelationByIndex(7)
	if err != nil {
		return err
...
func (a *accountsQueryBuilder) IncludeRoles(rolesFieldset ...string) *accountsQueryBuilder {
	...
	if err != nil {
		a.err = errors.Wrapf(mapping.ErrInternal, "Getting 'Roles' by index for model 'Account' failed: %v", err)
		return a
	}
...
func (a *accountsQueryBuilder) AddRoles(_roles ...*Role) error {
	...
	relation, err := NRN_Accounts.Model.RelationByIndex(7)
	if err != nil {
		return errors.Wrapf(mapping.ErrInternal, "getting 'Roles' relation by index for model 'Account' failed: %v", err)
	}
...
func (a *accountsQueryBuilder) RemoveRoles() (int64, error) {
	...
	relation, err := NRN_Accounts.Model.RelationByIndex(7)
	if err != nil {
		return 0, errors.Wrapf(mapping.ErrInternal, "getting 'Roles' relation by index for model 'Account' failed: %v", err)
	}
...
// BelongsTo, HasOne, HasMany if foreign key is not nullable than the function would return an error.
func (a *_AccountRoles) ClearAccountRelation(ctx context.Context, db database.DB, models ...*AccountRoles) (int64, error) {
...
func (a *_AccountRoles) GetAccount(ctx context.Context, db database.DB, model *AccountRoles, relationFieldset ...string) (*Account, error) {
	if model == nil {
		return nil, errors.Wrap(query.ErrNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	...
	if len(relationFieldset) == 0 {
		...
		for _, field := range relationFieldset {
			sField, ok := relationModel.FieldByName(field)
			if !ok {
				return nil, errors.Wrapf(mapping.ErrInvalidModelField, "no field: '%s' found for the model: 'Account'", field)
			}
			fields = append(fields, sField)
		}
	}
...
func (a *_AccountRoles) SetAccount(ctx context.Context, db database.DB, model *AccountRoles, relation *Account) error {
	if model == nil {
		return errors.Wrap(query.ErrNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	...
	q := query.NewScope(a.Model, model)
	if relation.IsPrimaryKeyZero() {
		return errors.Wrap(mapping.ErrFieldValue, "relation 'Account' model has zero value primary field")
	}
	relationSetter, ok := db.(database.QueryRelationSetter)
	if !ok {
		return errors.WrapDetf(query.ErrInternal, "DB doesn't implement QueryRelationSetter interface: %T", db)
...
func (a *accountRolesQueryBuilder) IncludeAccount(accountFieldset ...string) *accountRolesQueryBuilder {
	...
	if err != nil {
		a.err = errors.Wrapf(mapping.ErrInternal, "Getting 'Account' by index for model 'AccountRoles' failed: %v", err)
		return a
	}
	// check the fieldset for the relation.
	var relationFields []*mapping.StructField
	for _, field := range accountFieldset {
		structField, ok := relation.ModelStruct().FieldByName(field)
		if !ok {
			a.err = errors.Wrapf(mapping.ErrInvalidModelField, "field: '%s' is not found for the 'Account' model", field)
			return a
		}
		relationFields = append(relationFields, structField)
	}
...
func (a *accountRolesQueryBuilder) AddAccount(_account *Account) error {
	...
	relation, err := NRN_AccountRoles.Model.RelationByIndex(5)
	if err != nil {
		return errors.Wrapf(mapping.ErrInternal, "getting 'Account' relation by index for model 'AccountRoles' failed: %v", err)
	}
...
func (a *accountRolesQueryBuilder) RemoveAccount() (int64, error) {
	...
	relation, err := NRN_AccountRoles.Model.RelationByIndex(5)
	if err != nil {
		return 0, errors.Wrapf(mapping.ErrInternal, "getting 'Account' relation by index for model 'AccountRoles' failed: %v", err)
	}
	return a.builder.RemoveRelations(relation)
}
...
func (r *_Roles) AddAccounts(ctx context.Context, db database.DB, model *Role, relations ...*Account) error {
	if model == nil {
		return errors.Wrap(query.ErrNoModels, "provided nil model")
	}
	if len(relations) == 0 {
...
func (r *_Roles) GetAccounts(ctx context.Context, db database.DB, model *Role, relationFieldset ...string) ([]*Account, error) {
	if model == nil {
		return nil, errors.Wrap(query.ErrNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
...
func (r *_Roles) SetAccounts(ctx context.Context, db database.DB, model *Role, relations ...*Account) error {
	if model == nil {
		return errors.Wrap(query.ErrNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
...
func (r *rolesQueryBuilder) IncludeAccounts(accountsFieldset ...string) *rolesQueryBuilder {
	...
	for _, field := range accountsFieldset {
		structField, ok := relation.ModelStruct().FieldByName(field)
		if !ok {
			r.err = errors.Wrapf(mapping.ErrInvalidModelField, "field: '%s' is not found for the 'Account' model", field)
			return r
		}
		relationFields = append(relationFields, structField)
	}
