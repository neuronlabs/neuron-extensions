...
func (a *_Accounts) InitializeCollection(c *controller.Controller) error {
...
func (a *_Accounts) Query(db db.DB, models ...*Account) *accountsQueryBuilder {
...
func (a *_Accounts) QueryCtx(ctx context.Context, db db.DB, models ...*Account) *accountsQueryBuilder {
	var queryModels []mapping.Model
	if len(models) > 0 {
		queryModels = make([]mapping.Model, len(models))
		for i, model := range models {
...
func (a *_Accounts) Insert(ctx context.Context, db db.DB, models ...*Account) error {
	if len(models) == 0 {
...
func (a *_Accounts) Update(ctx context.Context, db db.DB, models ...*Account) (int64, error) {
	if len(models) == 0 {
		return 0, errors.New(query.ClassNoModels, "nothing to insert")
	}
	queryModels := make([]mapping.Model, len(models))
	for i, model := range models {
		queryModels[i] = model
...
func (a *_Accounts) Delete(ctx context.Context, db db.DB, models ...*Account) (int64, error) {
	if len(models) == 0 {
		return 0, errors.New(query.ClassNoModels, "nothing to insert")
	}
	queryModels := make([]mapping.Model, len(models))
...
// DeleteAll deletes all models Account from database.
// Warning: This function deletes all models, be careful.
func (a *_Accounts) DeleteAll(ctx context.Context, db db.DB) (int64, error) {
	return db.DeleteAll(ctx, a.Model)
}

// Refresh creates the query for the Account with provided 'ctx' context.
func (a *_Accounts) Refresh(ctx context.Context, db db.DB, models ...*Account) error {
	var queryModels []mapping.Model
	if len(models) == 0 {
		return errors.New(query.ClassNoModels, "nothing to refresh")
	}
	queryModels = make([]mapping.Model, len(models))
	for i, model := range models {
		queryModels[i] = model
...
func (a *_Accounts) AddRoles(ctx context.Context, _db db.DB, model *Account, relations ...*Role) error {
	if model == nil {
		return errors.New(query.ClassNoModels, "provided nil model")
	}
	if len(relations) == 0 {
		return errors.New(query.ClassNoModels, "no relation models provided")
	}
	relationField, err := a.Model.RelationByIndex(7)
	if err != nil {
		return 0, err
	}
	...
	return db.AddRelations(ctx, _db, q, relationField, relationModels...)
}
...
func (a *_Accounts) ClearRolesRelation(ctx context.Context, _db db.DB, models ...*Account) (int64, error) {
	relation, err := a.Model.RelationByIndex(7)
	if err != nil {
		return 0, err
	}
	...
	return db.ClearRelations(ctx, _db, s, relation)
}

// GetRoles gets the 'Roles' relationship for provided input 'model'.
func (a *_Accounts) GetRoles(ctx context.Context, _db db.DB, model *Account, relationFieldset ...string) ([]*Role, error) {
	if model == nil {
		return nil, errors.New(query.ClassNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return nil, errors.New(mapping.ClassFieldValue, "model's: 'Account' primary key value has zero value")
	}
	relationField, err := a.Model.RelationByIndex(7)
	if err != nil {
		return nil, err
	...
	relationModel := relationField.Relationship.Struct()
	if len(relationFieldset) == 0 {
		...
		for _, field := range relationFieldset {
			...
			if !ok {
				return nil, errors.Newf(mapping.ClassInvalidModelField, "no field: '%s' found for the model: 'Role'", field)
			}
			fields = append(fields, sField)
		}
	}
	q := query.NewScope(a.Model, model)
	relations, err := db.GetRelations(ctx, _db, q, relationField, fields...)
	if err != nil {
		return nil, err
	}
	if len(relations) == 0 {
...
func (a *_Accounts) SetRoles(ctx context.Context, _db db.DB, model *Account, relations ...*Role) error {
	if model == nil {
		return errors.New(query.ClassNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "model's: 'Account' primary key value has zero value")
	}
	relationField, err := a.Model.RelationByIndex(7)
	if err != nil {
		return 0, err
	...
	for i, relation := range relations {
		if relation.IsPrimaryKeyZero() {
			return errors.New(mapping.ClassFieldValue, "one of relation 'Roles' model has zero value primary field")
		}
		relationModels[i] = relation
	}
	return db.SetRelations(ctx, _db, q, relationField, relationModels...)
}
...
// IncludeRoles includes given 'relation' in the _Accounts query.
// An optional 'relationFieldset' defines the fields to return in the included relation.
func (a *accountsQueryBuilder) IncludeRoles(rolesFieldset ...string) *accountsQueryBuilder {
	if a.err != nil {
		return a
	}
	relation, err := NRN_Accounts.Model.RelationByIndex(7)
	if err != nil {
		a.err = errors.Newf(mapping.ClassInternal, "Getting 'Roles' by index for model 'Account' failed: %v", err)
		return a
	}
	...
	for _, field := range rolesFieldset {
		...
		if !ok {
			a.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not found for the 'Role' model", field)
			return a
		}
...
func (a *accountsQueryBuilder) Select(fields ...string) *accountsQueryBuilder {
	...
	for _, field := range fields {
		...
		if !ok {
			a.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not valid for model: '_Accounts'", field)
			return a
		}
...
func (a *accountsQueryBuilder) OrderBy(fields ...string) *accountsQueryBuilder {
	...
	for i, field := range fields {
		if len(field) == 0 {
			a.err = errors.New(mapping.ClassInvalidModelField, "cannot set sorting order for an empty field for model: '_Accounts'")
			return a
		}
...
// AddRoles adds related model Roles and matches to given Account.
func (a *accountsQueryBuilder) AddRoles(_roles ...*Role) error {
	if a.err != nil {
		return a.err
	}
	relation, err := NRN_Accounts.Model.RelationByIndex(7)
	if err != nil {
		return errors.Newf(mapping.ClassInternal, "getting 'Roles' relation by index for model 'Account' failed: %v", err)
	}
...
// SetRoles sets related model Roles and matches to given Account.
func (a *accountsQueryBuilder) SetRoles(_roles ...*Role) error {
	if a.err != nil {
		return a.err
	}
	relation, err := NRN_Accounts.Model.RelationByIndex(7)
...
// RemoveRoles removes related model Roles and matches to given Account.
func (a *accountsQueryBuilder) RemoveRoles() (int64, error) {
	if a.err != nil {
		return 0, a.err
	}
	relation, err := NRN_Accounts.Model.RelationByIndex(7)
	if err != nil {
		return 0, errors.Newf(mapping.ClassInternal, "getting 'Roles' relation by index for model 'Account' failed: %v", err)
	}
...
// InitializeCollection implements db.Collection interface.
func (a *_AccountRoles) InitializeCollection(c *controller.Controller) error {
	mStruct, err := c.ModelStruct(&AccountRoles{})
	if err != nil {
		return err
	}
...
func (a *_AccountRoles) Query(db db.DB, models ...*AccountRoles) *accountRolesQueryBuilder {
	var queryModels []mapping.Model
	if len(models) > 0 {
		queryModels = make([]mapping.Model, len(models))
		for i, model := range models {
...
func (a *_AccountRoles) QueryCtx(ctx context.Context, db db.DB, models ...*AccountRoles) *accountRolesQueryBuilder {
	var queryModels []mapping.Model
	if len(models) > 0 {
		queryModels = make([]mapping.Model, len(models))
		for i, model := range models {
...
func (a *_AccountRoles) Insert(ctx context.Context, db db.DB, models ...*AccountRoles) error {
	if len(models) == 0 {
		return errors.New(query.ClassNoModels, "nothing to insert")
	}
	queryModels := make([]mapping.Model, len(models))
...
func (a *_AccountRoles) Update(ctx context.Context, db db.DB, models ...*AccountRoles) (int64, error) {
	if len(models) == 0 {
		return 0, errors.New(query.ClassNoModels, "nothing to insert")
	}
	queryModels := make([]mapping.Model, len(models))
...
func (a *_AccountRoles) Delete(ctx context.Context, db db.DB, models ...*AccountRoles) (int64, error) {
	if len(models) == 0 {
		return 0, errors.New(query.ClassNoModels, "nothing to insert")
	}
	queryModels := make([]mapping.Model, len(models))
...
// DeleteAll deletes all models AccountRoles from database.
// Warning: This function deletes all models, be careful.
func (a *_AccountRoles) DeleteAll(ctx context.Context, db db.DB) (int64, error) {
	return db.DeleteAll(ctx, a.Model)
}

// Refresh creates the query for the AccountRoles with provided 'ctx' context.
func (a *_AccountRoles) Refresh(ctx context.Context, db db.DB, models ...*AccountRoles) error {
	var queryModels []mapping.Model
	if len(models) == 0 {
		return errors.New(query.ClassNoModels, "nothing to refresh")
	}
...
// BelongsTo, HasOne, HasMany if foreign key is not nullable than the function would return an error.
func (a *_AccountRoles) ClearRoleRelation(ctx context.Context, _db db.DB, models ...*AccountRoles) (int64, error) {
	relation, err := a.Model.RelationByIndex(3)
	if err != nil {
		return 0, err
	}
	modelInterfaces := make([]mapping.Model, len(models))
...
func (a *_AccountRoles) GetRole(ctx context.Context, _db db.DB, model *AccountRoles, relationFieldset ...string) (*Role, error) {
	if model == nil {
		return nil, errors.New(query.ClassNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return nil, errors.New(mapping.ClassFieldValue, "model's: 'AccountRoles' primary key value has zero value")
	}
	relationField, err := a.Model.RelationByIndex(3)
	if err != nil {
		return nil, err
	}
...
func (a *_AccountRoles) SetRole(ctx context.Context, _db db.DB, model *AccountRoles, relation *Role) error {
	if model == nil {
		return errors.New(query.ClassNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "model's: 'AccountRoles' primary key value has zero value")
	}
	relationField, err := a.Model.RelationByIndex(3)
	if err != nil {
		return 0, err
	...
	q := query.NewScope(a.Model, model)
	if relation.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "relation 'Role' model has zero value primary field")
	}
	return db.SetRelations(ctx, _db, q, relationField, relation)
}

// ClearAccountRelation clears the 'Account' relationship for provided models. For relationships of type:
// BelongsTo, HasOne, HasMany if foreign key is not nullable than the function would return an error.
func (a *_AccountRoles) ClearAccountRelation(ctx context.Context, _db db.DB, models ...*AccountRoles) (int64, error) {
...
// GetAccount gets the 'Account' relationship for provided input 'model'.
func (a *_AccountRoles) GetAccount(ctx context.Context, _db db.DB, model *AccountRoles, relationFieldset ...string) (*Account, error) {
	if model == nil {
		return nil, errors.New(query.ClassNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	...
	if len(relationFieldset) == 0 {
		...
		for _, field := range relationFieldset {
			sField, ok := relationModel.FieldByName(field)
			if !ok {
				return nil, errors.Newf(mapping.ClassInvalidModelField, "no field: '%s' found for the model: 'Account'", field)
			}
			fields = append(fields, sField)
		}
	}
	...
	return relations[0].(*Account), nil
}

// SetAccount sets the 'Account' relationship for provided input 'models'.
func (a *_AccountRoles) SetAccount(ctx context.Context, _db db.DB, model *AccountRoles, relation *Account) error {
	if model == nil {
		return errors.New(query.ClassNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	...
	q := query.NewScope(a.Model, model)
	if relation.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "relation 'Account' model has zero value primary field")
	}
	return db.SetRelations(ctx, _db, q, relationField, relation)
}
...
// UpdateAll updates all 'AccountRoles' in the collection.
func (a *accountRolesQueryBuilder) UpdateAll() (int64, error) {
	if a.err != nil {
		return 0, a.err
	}
	return a.builder.UpdateAll()
...
// DeleteAll deletes all AccountRoles instances in the repository.
func (a *accountRolesQueryBuilder) DeleteAll() (int64, error) {
	if a.err != nil {
		return 0, a.err
	}
	return a.builder.DeleteAll()
...
func (a *accountRolesQueryBuilder) IncludeRole(roleFieldset ...string) *accountRolesQueryBuilder {
	...
	relation, err := NRN_AccountRoles.Model.RelationByIndex(3)
	if err != nil {
		a.err = errors.Newf(mapping.ClassInternal, "Getting 'Role' by index for model 'AccountRoles' failed: %v", err)
		return a
	}
	// check the fieldset for the relation.
	var relationFields []*mapping.StructField
...
// IncludeAccount includes given 'relation' in the _AccountRoles query.
// An optional 'relationFieldset' defines the fields to return in the included relation.
func (a *accountRolesQueryBuilder) IncludeAccount(accountFieldset ...string) *accountRolesQueryBuilder {
	if a.err != nil {
		return a
	}
	relation, err := NRN_AccountRoles.Model.RelationByIndex(5)
	if err != nil {
		a.err = errors.Newf(mapping.ClassInternal, "Getting 'Account' by index for model 'AccountRoles' failed: %v", err)
		return a
	}
	// check the fieldset for the relation.
	var relationFields []*mapping.StructField
	for _, field := range accountFieldset {
		structField, ok := relation.ModelStruct().FieldByName(field)
		if !ok {
			a.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not found for the 'Account' model", field)
			return a
		}
		relationFields = append(relationFields, structField)
	}
...
func (a *accountRolesQueryBuilder) Select(fields ...string) *accountRolesQueryBuilder {
	...
	for _, field := range fields {
		...
		if !ok {
			a.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not valid for model: '_AccountRoles'", field)
			return a
		}
		fieldSet = append(fieldSet, structField)
	}
...
func (a *accountRolesQueryBuilder) OrderBy(fields ...string) *accountRolesQueryBuilder {
	...
	for i, field := range fields {
		if len(field) == 0 {
			a.err = errors.New(mapping.ClassInvalidModelField, "cannot set sorting order for an empty field for model: '_AccountRoles'")
			return a
		}
		var order query.SortOrder
		if field[0] == '-' {
...
func (a *accountRolesQueryBuilder) AddRole(_role *Role) error {
	...
	relation, err := NRN_AccountRoles.Model.RelationByIndex(3)
	if err != nil {
		return errors.Newf(mapping.ClassInternal, "getting 'Role' relation by index for model 'AccountRoles' failed: %v", err)
	}
	return a.builder.AddRelations(relation, _role)
}

// AddAccount adds related model Account and matches to given AccountRoles.
func (a *accountRolesQueryBuilder) AddAccount(_account *Account) error {
	if a.err != nil {
		return a.err
	}
	relation, err := NRN_AccountRoles.Model.RelationByIndex(5)
	if err != nil {
		return errors.Newf(mapping.ClassInternal, "getting 'Account' relation by index for model 'AccountRoles' failed: %v", err)
	}
	return a.builder.AddRelations(relation, _account)
}
...
// SetAccount sets related model Account and matches to given AccountRoles.
func (a *accountRolesQueryBuilder) SetAccount(_account *Account) error {
	if a.err != nil {
		return a.err
	}
	relation, err := NRN_AccountRoles.Model.RelationByIndex(5)
	...
	return a.builder.SetRelations(relation, _account)
}
...
func (a *accountRolesQueryBuilder) RemoveRole() (int64, error) {
	...
	relation, err := NRN_AccountRoles.Model.RelationByIndex(3)
	if err != nil {
		return 0, errors.Newf(mapping.ClassInternal, "getting 'Role' relation by index for model 'AccountRoles' failed: %v", err)
	}
	return a.builder.RemoveRelations(relation)
}

// RemoveAccount removes related model Account and matches to given AccountRoles.
func (a *accountRolesQueryBuilder) RemoveAccount() (int64, error) {
	if a.err != nil {
		return 0, a.err
	}
	relation, err := NRN_AccountRoles.Model.RelationByIndex(5)
	if err != nil {
		return 0, errors.Newf(mapping.ClassInternal, "getting 'Account' relation by index for model 'AccountRoles' failed: %v", err)
	}
	return a.builder.RemoveRelations(relation)
}
...
// InitializeCollection implements db.Collection interface.
func (a *_AuthorizeScopes) InitializeCollection(c *controller.Controller) error {
	mStruct, err := c.ModelStruct(&AuthorizeScope{})
	if err != nil {
		return err
	}
...
func (a *_AuthorizeScopes) Query(db db.DB, models ...*AuthorizeScope) *authorizeScopesQueryBuilder {
	var queryModels []mapping.Model
	if len(models) > 0 {
		queryModels = make([]mapping.Model, len(models))
		for i, model := range models {
...
func (a *_AuthorizeScopes) QueryCtx(ctx context.Context, db db.DB, models ...*AuthorizeScope) *authorizeScopesQueryBuilder {
	var queryModels []mapping.Model
	if len(models) > 0 {
		queryModels = make([]mapping.Model, len(models))
		for i, model := range models {
...
func (a *_AuthorizeScopes) Insert(ctx context.Context, db db.DB, models ...*AuthorizeScope) error {
	if len(models) == 0 {
		return errors.New(query.ClassNoModels, "nothing to insert")
	}
	queryModels := make([]mapping.Model, len(models))
...
func (a *_AuthorizeScopes) Update(ctx context.Context, db db.DB, models ...*AuthorizeScope) (int64, error) {
	if len(models) == 0 {
		return 0, errors.New(query.ClassNoModels, "nothing to insert")
	}
	queryModels := make([]mapping.Model, len(models))
...
func (a *_AuthorizeScopes) Delete(ctx context.Context, db db.DB, models ...*AuthorizeScope) (int64, error) {
	if len(models) == 0 {
		return 0, errors.New(query.ClassNoModels, "nothing to insert")
	}
	queryModels := make([]mapping.Model, len(models))
...
// DeleteAll deletes all models AuthorizeScope from database.
// Warning: This function deletes all models, be careful.
func (a *_AuthorizeScopes) DeleteAll(ctx context.Context, db db.DB) (int64, error) {
	return db.DeleteAll(ctx, a.Model)
}

// Refresh creates the query for the AuthorizeScope with provided 'ctx' context.
func (a *_AuthorizeScopes) Refresh(ctx context.Context, db db.DB, models ...*AuthorizeScope) error {
	var queryModels []mapping.Model
	if len(models) == 0 {
		return errors.New(query.ClassNoModels, "nothing to refresh")
	}
...
// AddRoles adds the 'Roles' relationship for provided input 'models'.
func (a *_AuthorizeScopes) AddRoles(ctx context.Context, _db db.DB, model *AuthorizeScope, relations ...*Role) error {
	if model == nil {
		return errors.New(query.ClassNoModels, "provided nil model")
	}
	if len(relations) == 0 {
...
// ClearRolesRelation clears the 'Roles' relationship for provided models. For relationships of type:
// BelongsTo, HasOne, HasMany if foreign key is not nullable than the function would return an error.
func (a *_AuthorizeScopes) ClearRolesRelation(ctx context.Context, _db db.DB, models ...*AuthorizeScope) (int64, error) {
	relation, err := a.Model.RelationByIndex(5)
	if err != nil {
		return 0, err
	}
...
// GetRoles gets the 'Roles' relationship for provided input 'model'.
func (a *_AuthorizeScopes) GetRoles(ctx context.Context, _db db.DB, model *AuthorizeScope, relationFieldset ...string) ([]*Role, error) {
	if model == nil {
		return nil, errors.New(query.ClassNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return nil, errors.New(mapping.ClassFieldValue, "model's: 'AuthorizeScope' primary key value has zero value")
	}
	relationField, err := a.Model.RelationByIndex(5)
	if err != nil {
		return nil, err
...
// SetRoles sets the 'Roles' relationship for provided input 'models'.
func (a *_AuthorizeScopes) SetRoles(ctx context.Context, _db db.DB, model *AuthorizeScope, relations ...*Role) error {
	if model == nil {
		return errors.New(query.ClassNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "model's: 'AuthorizeScope' primary key value has zero value")
	}
	relationField, err := a.Model.RelationByIndex(5)
	if err != nil {
		return 0, err
...
// UpdateAll updates all 'AuthorizeScope' in the collection.
func (a *authorizeScopesQueryBuilder) UpdateAll() (int64, error) {
	if a.err != nil {
		return 0, a.err
	}
	return a.builder.UpdateAll()
...
// DeleteAll deletes all AuthorizeScope instances in the repository.
func (a *authorizeScopesQueryBuilder) DeleteAll() (int64, error) {
	if a.err != nil {
		return 0, a.err
	}
	return a.builder.DeleteAll()
...
func (a *authorizeScopesQueryBuilder) IncludeRoles(rolesFieldset ...string) *authorizeScopesQueryBuilder {
	...
	if err != nil {
		a.err = errors.Newf(mapping.ClassInternal, "Getting 'Roles' by index for model 'AuthorizeScope' failed: %v", err)
		return a
	}
	// check the fieldset for the relation.
	var relationFields []*mapping.StructField
...
func (a *authorizeScopesQueryBuilder) Select(fields ...string) *authorizeScopesQueryBuilder {
	...
	for _, field := range fields {
		...
		if !ok {
			a.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not valid for model: '_AuthorizeScopes'", field)
			return a
		}
		fieldSet = append(fieldSet, structField)
	}
...
func (a *authorizeScopesQueryBuilder) OrderBy(fields ...string) *authorizeScopesQueryBuilder {
	...
	for i, field := range fields {
		if len(field) == 0 {
			a.err = errors.New(mapping.ClassInvalidModelField, "cannot set sorting order for an empty field for model: '_AuthorizeScopes'")
			return a
		}
		var order query.SortOrder
		if field[0] == '-' {
...
func (a *authorizeScopesQueryBuilder) AddRoles(_roles ...*Role) error {
	...
	relation, err := NRN_AuthorizeScopes.Model.RelationByIndex(5)
	if err != nil {
		return errors.Newf(mapping.ClassInternal, "getting 'Roles' relation by index for model 'AuthorizeScope' failed: %v", err)
	}
	models := make([]mapping.Model, len(_roles))
	for i := range _roles {
		models[i] = _roles[i]
...
func (a *authorizeScopesQueryBuilder) RemoveRoles() (int64, error) {
	...
	relation, err := NRN_AuthorizeScopes.Model.RelationByIndex(5)
	if err != nil {
		return 0, errors.Newf(mapping.ClassInternal, "getting 'Roles' relation by index for model 'AuthorizeScope' failed: %v", err)
	}
	return a.builder.RemoveRelations(relation)
}
...
// InitializeCollection implements db.Collection interface.
func (r *_Roles) InitializeCollection(c *controller.Controller) error {
	mStruct, err := c.ModelStruct(&Role{})
	if err != nil {
		return err
	}
...
func (r *_Roles) Query(db db.DB, models ...*Role) *rolesQueryBuilder {
	var queryModels []mapping.Model
	if len(models) > 0 {
		queryModels = make([]mapping.Model, len(models))
		for i, model := range models {
...
func (r *_Roles) QueryCtx(ctx context.Context, db db.DB, models ...*Role) *rolesQueryBuilder {
	var queryModels []mapping.Model
	if len(models) > 0 {
		queryModels = make([]mapping.Model, len(models))
		for i, model := range models {
...
func (r *_Roles) Insert(ctx context.Context, db db.DB, models ...*Role) error {
	if len(models) == 0 {
		return errors.New(query.ClassNoModels, "nothing to insert")
	}
	queryModels := make([]mapping.Model, len(models))
...
func (r *_Roles) Update(ctx context.Context, db db.DB, models ...*Role) (int64, error) {
	if len(models) == 0 {
		return 0, errors.New(query.ClassNoModels, "nothing to insert")
	}
	queryModels := make([]mapping.Model, len(models))
...
func (r *_Roles) Delete(ctx context.Context, db db.DB, models ...*Role) (int64, error) {
	if len(models) == 0 {
		return 0, errors.New(query.ClassNoModels, "nothing to insert")
	}
	queryModels := make([]mapping.Model, len(models))
...
// DeleteAll deletes all models Role from database.
// Warning: This function deletes all models, be careful.
func (r *_Roles) DeleteAll(ctx context.Context, db db.DB) (int64, error) {
	return db.DeleteAll(ctx, r.Model)
}

// Refresh creates the query for the Role with provided 'ctx' context.
func (r *_Roles) Refresh(ctx context.Context, db db.DB, models ...*Role) error {
	var queryModels []mapping.Model
	if len(models) == 0 {
		return errors.New(query.ClassNoModels, "nothing to refresh")
	}
...
func (r *_Roles) AddAccounts(ctx context.Context, _db db.DB, model *Role, relations ...*Account) error {
	if model == nil {
		return errors.New(query.ClassNoModels, "provided nil model")
	}
	if len(relations) == 0 {
	...
	relationField, err := r.Model.RelationByIndex(6)
	if err != nil {
		return 0, err
	}
	relationModels := make([]mapping.Model, len(relations))
...
// BelongsTo, HasOne, HasMany if foreign key is not nullable than the function would return an error.
func (r *_Roles) ClearAccountsRelation(ctx context.Context, _db db.DB, models ...*Role) (int64, error) {
	relation, err := r.Model.RelationByIndex(6)
	if err != nil {
		return 0, err
	}
	modelInterfaces := make([]mapping.Model, len(models))
...
func (r *_Roles) GetAccounts(ctx context.Context, _db db.DB, model *Role, relationFieldset ...string) ([]*Account, error) {
	if model == nil {
		return nil, errors.New(query.ClassNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return nil, errors.New(mapping.ClassFieldValue, "model's: 'Role' primary key value has zero value")
	}
	relationField, err := r.Model.RelationByIndex(6)
	if err != nil {
		return nil, err
	...
	result := make([]*Account, len(relations))
	for i, relation := range relations {
		result[i] = relation.(*Account)
	}
	return result, nil
}

// SetAccounts sets the 'Accounts' relationship for provided input 'models'.
func (r *_Roles) SetAccounts(ctx context.Context, _db db.DB, model *Role, relations ...*Account) error {
	if model == nil {
		return errors.New(query.ClassNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "model's: 'Role' primary key value has zero value")
	}
	relationField, err := r.Model.RelationByIndex(6)
	if err != nil {
		return 0, err
	...
	for i, relation := range relations {
		if relation.IsPrimaryKeyZero() {
			return errors.New(mapping.ClassFieldValue, "one of relation 'Accounts' model has zero value primary field")
		}
		relationModels[i] = relation
	}
	return db.SetRelations(ctx, _db, q, relationField, relationModels...)
...
func (r *_Roles) AddScopes(ctx context.Context, _db db.DB, model *Role, relations ...*AuthorizeScope) error {
	if model == nil {
		return errors.New(query.ClassNoModels, "provided nil model")
	}
	if len(relations) == 0 {
...
// BelongsTo, HasOne, HasMany if foreign key is not nullable than the function would return an error.
func (r *_Roles) ClearScopesRelation(ctx context.Context, _db db.DB, models ...*Role) (int64, error) {
...
func (r *_Roles) GetScopes(ctx context.Context, _db db.DB, model *Role, relationFieldset ...string) ([]*AuthorizeScope, error) {
	if model == nil {
		return nil, errors.New(query.ClassNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	...
	if len(relationFieldset) == 0 {
		...
		for _, field := range relationFieldset {
			sField, ok := relationModel.FieldByName(field)
			if !ok {
				return nil, errors.Newf(mapping.ClassInvalidModelField, "no field: '%s' found for the model: 'AuthorizeScope'", field)
			}
			fields = append(fields, sField)
		}
	}
...
func (r *_Roles) SetScopes(ctx context.Context, _db db.DB, model *Role, relations ...*AuthorizeScope) error {
	if model == nil {
		return errors.New(query.ClassNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	...
	for i, relation := range relations {
		if relation.IsPrimaryKeyZero() {
			return errors.New(mapping.ClassFieldValue, "one of relation 'Scopes' model has zero value primary field")
		}
		relationModels[i] = relation
	}
	return db.SetRelations(ctx, _db, q, relationField, relationModels...)
...
// UpdateAll updates all 'Role' in the collection.
func (r *rolesQueryBuilder) UpdateAll() (int64, error) {
	if r.err != nil {
		return 0, r.err
	}
	return r.builder.UpdateAll()
}
...
// DeleteAll deletes all Role instances in the repository.
func (r *rolesQueryBuilder) DeleteAll() (int64, error) {
	if r.err != nil {
		return 0, r.err
	}
	return r.builder.DeleteAll()
}
...
func (r *rolesQueryBuilder) IncludeAccounts(accountsFieldset ...string) *rolesQueryBuilder {
	...
	relation, err := NRN_Roles.Model.RelationByIndex(6)
	if err != nil {
		r.err = errors.Newf(mapping.ClassInternal, "Getting 'Accounts' by index for model 'Role' failed: %v", err)
		return r
	}
	// check the fieldset for the relation.
	var relationFields []*mapping.StructField
	for _, field := range accountsFieldset {
		structField, ok := relation.ModelStruct().FieldByName(field)
		if !ok {
			r.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not found for the 'Account' model", field)
			return r
		}
		relationFields = append(relationFields, structField)
	}
...
func (r *rolesQueryBuilder) IncludeScopes(scopesFieldset ...string) *rolesQueryBuilder {
	...
	if err != nil {
		r.err = errors.Newf(mapping.ClassInternal, "Getting 'Scopes' by index for model 'Role' failed: %v", err)
		return r
	}
	// check the fieldset for the relation.
	var relationFields []*mapping.StructField
	for _, field := range scopesFieldset {
		structField, ok := relation.ModelStruct().FieldByName(field)
		if !ok {
			r.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not found for the 'AuthorizeScope' model", field)
			return r
		}
		relationFields = append(relationFields, structField)
	}
...
func (r *rolesQueryBuilder) Select(fields ...string) *rolesQueryBuilder {
	...
	for _, field := range fields {
		...
		if !ok {
			r.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not valid for model: '_Roles'", field)
			return r
		}
		fieldSet = append(fieldSet, structField)
	}
...
func (r *rolesQueryBuilder) OrderBy(fields ...string) *rolesQueryBuilder {
	...
	for i, field := range fields {
		if len(field) == 0 {
			r.err = errors.New(mapping.ClassInvalidModelField, "cannot set sorting order for an empty field for model: '_Roles'")
			return r
		}
		var order query.SortOrder
		if field[0] == '-' {
...
func (r *rolesQueryBuilder) AddAccounts(_accounts ...*Account) error {
	if r.err != nil {
		return r.err
	}
	relation, err := NRN_Roles.Model.RelationByIndex(6)
	if err != nil {
		return errors.Newf(mapping.ClassInternal, "getting 'Accounts' relation by index for model 'Role' failed: %v", err)
	}
...
func (r *rolesQueryBuilder) AddScopes(_scopes ...*AuthorizeScope) error {
	...
	relation, err := NRN_Roles.Model.RelationByIndex(7)
	if err != nil {
		return errors.Newf(mapping.ClassInternal, "getting 'Scopes' relation by index for model 'Role' failed: %v", err)
	}
...
func (r *rolesQueryBuilder) SetAccounts(_accounts ...*Account) error {
	if r.err != nil {
		return r.err
	}
	relation, err := NRN_Roles.Model.RelationByIndex(6)
...
func (r *rolesQueryBuilder) RemoveAccounts() (int64, error) {
	...
	relation, err := NRN_Roles.Model.RelationByIndex(6)
	if err != nil {
		return 0, errors.Newf(mapping.ClassInternal, "getting 'Accounts' relation by index for model 'Role' failed: %v", err)
	}
...
func (r *rolesQueryBuilder) RemoveScopes() (int64, error) {
	...
	relation, err := NRN_Roles.Model.RelationByIndex(7)
	if err != nil {
		return 0, errors.Newf(mapping.ClassInternal, "getting 'Scopes' relation by index for model 'Role' failed: %v", err)
	}
	return r.builder.RemoveRelations(relation)
}
...
// InitializeCollection implements db.Collection interface.
func (r *_RoleScopes) InitializeCollection(c *controller.Controller) error {
	mStruct, err := c.ModelStruct(&RoleScopes{})
	if err != nil {
		return err
	}
...
func (r *_RoleScopes) Query(db db.DB, models ...*RoleScopes) *roleScopesQueryBuilder {
	var queryModels []mapping.Model
	if len(models) > 0 {
		queryModels = make([]mapping.Model, len(models))
		for i, model := range models {
...
func (r *_RoleScopes) QueryCtx(ctx context.Context, db db.DB, models ...*RoleScopes) *roleScopesQueryBuilder {
	var queryModels []mapping.Model
	if len(models) > 0 {
		queryModels = make([]mapping.Model, len(models))
		for i, model := range models {
...
func (r *_RoleScopes) Insert(ctx context.Context, db db.DB, models ...*RoleScopes) error {
	if len(models) == 0 {
		return errors.New(query.ClassNoModels, "nothing to insert")
	}
	queryModels := make([]mapping.Model, len(models))
...
func (r *_RoleScopes) Update(ctx context.Context, db db.DB, models ...*RoleScopes) (int64, error) {
	if len(models) == 0 {
		return 0, errors.New(query.ClassNoModels, "nothing to insert")
	}
	queryModels := make([]mapping.Model, len(models))
...
func (r *_RoleScopes) Delete(ctx context.Context, db db.DB, models ...*RoleScopes) (int64, error) {
	if len(models) == 0 {
		return 0, errors.New(query.ClassNoModels, "nothing to insert")
	}
	queryModels := make([]mapping.Model, len(models))
...
// DeleteAll deletes all models RoleScopes from database.
// Warning: This function deletes all models, be careful.
func (r *_RoleScopes) DeleteAll(ctx context.Context, db db.DB) (int64, error) {
	return db.DeleteAll(ctx, r.Model)
}

// Refresh creates the query for the RoleScopes with provided 'ctx' context.
func (r *_RoleScopes) Refresh(ctx context.Context, db db.DB, models ...*RoleScopes) error {
	var queryModels []mapping.Model
	if len(models) == 0 {
		return errors.New(query.ClassNoModels, "nothing to refresh")
	}
...
// BelongsTo, HasOne, HasMany if foreign key is not nullable than the function would return an error.
func (r *_RoleScopes) ClearScopeRelation(ctx context.Context, _db db.DB, models ...*RoleScopes) (int64, error) {
...
func (r *_RoleScopes) GetScope(ctx context.Context, _db db.DB, model *RoleScopes, relationFieldset ...string) (*AuthorizeScope, error) {
	if model == nil {
		return nil, errors.New(query.ClassNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return nil, errors.New(mapping.ClassFieldValue, "model's: 'RoleScopes' primary key value has zero value")
	}
...
func (r *_RoleScopes) SetScope(ctx context.Context, _db db.DB, model *RoleScopes, relation *AuthorizeScope) error {
	if model == nil {
		return errors.New(query.ClassNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "model's: 'RoleScopes' primary key value has zero value")
	}
	relationField, err := r.Model.RelationByIndex(3)
	if err != nil {
		return 0, err
	...
	q := query.NewScope(r.Model, model)
	if relation.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "relation 'Scope' model has zero value primary field")
	}
	return db.SetRelations(ctx, _db, q, relationField, relation)
}
...
// ClearRoleRelation clears the 'Role' relationship for provided models. For relationships of type:
// BelongsTo, HasOne, HasMany if foreign key is not nullable than the function would return an error.
func (r *_RoleScopes) ClearRoleRelation(ctx context.Context, _db db.DB, models ...*RoleScopes) (int64, error) {
...
// GetRole gets the 'Role' relationship for provided input 'model'.
func (r *_RoleScopes) GetRole(ctx context.Context, _db db.DB, model *RoleScopes, relationFieldset ...string) (*Role, error) {
	if model == nil {
		return nil, errors.New(query.ClassNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
...
// SetRole sets the 'Role' relationship for provided input 'models'.
func (r *_RoleScopes) SetRole(ctx context.Context, _db db.DB, model *RoleScopes, relation *Role) error {
	if model == nil {
		return errors.New(query.ClassNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
...
// UpdateAll updates all 'RoleScopes' in the collection.
func (r *roleScopesQueryBuilder) UpdateAll() (int64, error) {
	if r.err != nil {
		return 0, r.err
	}
	return r.builder.UpdateAll()
...
// DeleteAll deletes all RoleScopes instances in the repository.
func (r *roleScopesQueryBuilder) DeleteAll() (int64, error) {
	if r.err != nil {
		return 0, r.err
	}
	return r.builder.DeleteAll()
...
func (r *roleScopesQueryBuilder) IncludeScope(scopeFieldset ...string) *roleScopesQueryBuilder {
	...
	if err != nil {
		r.err = errors.Newf(mapping.ClassInternal, "Getting 'Scope' by index for model 'RoleScopes' failed: %v", err)
		return r
	}
	// check the fieldset for the relation.
	var relationFields []*mapping.StructField
...
func (r *roleScopesQueryBuilder) IncludeRole(roleFieldset ...string) *roleScopesQueryBuilder {
	...
	if err != nil {
		r.err = errors.Newf(mapping.ClassInternal, "Getting 'Role' by index for model 'RoleScopes' failed: %v", err)
		return r
	}
	// check the fieldset for the relation.
	var relationFields []*mapping.StructField
	for _, field := range roleFieldset {
		structField, ok := relation.ModelStruct().FieldByName(field)
		if !ok {
			r.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not found for the 'Role' model", field)
			return r
		}
		relationFields = append(relationFields, structField)
	}
...
func (r *roleScopesQueryBuilder) Select(fields ...string) *roleScopesQueryBuilder {
	...
	for _, field := range fields {
		...
		if !ok {
			r.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not valid for model: '_RoleScopes'", field)
			return r
		}
		fieldSet = append(fieldSet, structField)
	}
...
func (r *roleScopesQueryBuilder) OrderBy(fields ...string) *roleScopesQueryBuilder {
	...
	for i, field := range fields {
		if len(field) == 0 {
			r.err = errors.New(mapping.ClassInvalidModelField, "cannot set sorting order for an empty field for model: '_RoleScopes'")
			return r
		}
		var order query.SortOrder
		if field[0] == '-' {
...
func (r *roleScopesQueryBuilder) AddScope(_scope *AuthorizeScope) error {
	...
	relation, err := NRN_RoleScopes.Model.RelationByIndex(3)
	if err != nil {
		return errors.Newf(mapping.ClassInternal, "getting 'Scope' relation by index for model 'RoleScopes' failed: %v", err)
	}
...
func (r *roleScopesQueryBuilder) AddRole(_role *Role) error {
	...
	relation, err := NRN_RoleScopes.Model.RelationByIndex(5)
	if err != nil {
		return errors.Newf(mapping.ClassInternal, "getting 'Role' relation by index for model 'RoleScopes' failed: %v", err)
	}
...
func (r *roleScopesQueryBuilder) RemoveScope() (int64, error) {
	...
	relation, err := NRN_RoleScopes.Model.RelationByIndex(3)
	if err != nil {
		return 0, errors.Newf(mapping.ClassInternal, "getting 'Scope' relation by index for model 'RoleScopes' failed: %v", err)
	}
	return r.builder.RemoveRelations(relation)
}
...
func (r *roleScopesQueryBuilder) RemoveRole() (int64, error) {
	...
	relation, err := NRN_RoleScopes.Model.RelationByIndex(5)
	if err != nil {
		return 0, errors.Newf(mapping.ClassInternal, "getting 'Role' relation by index for model 'RoleScopes' failed: %v", err)
	}
	return r.builder.RemoveRelations(relation)
}
