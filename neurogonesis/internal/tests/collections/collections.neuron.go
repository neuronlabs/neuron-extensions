...
func (_c *NRN_CustomCars) modelStruct(_db database.DB) (*mapping.ModelStruct, error) {
	if _c.mStruct != nil {
...
func (_c *NRN_CustomCars) Query(db database.DB, models ...*tests.Car) *customCarsQueryBuilder {
...
func (_c *NRN_CustomCars) QueryCtx(ctx context.Context, db database.DB, models ...*tests.Car) *customCarsQueryBuilder {
	var queryModels []mapping.Model
	if len(models) > 0 {
		queryModels = make([]mapping.Model, len(models))
		for i, model := range models {
...
func (_u *NRN_Users) modelStruct(_db database.DB) (*mapping.ModelStruct, error) {
	if _u.mStruct != nil {
...
func (_u *NRN_Users) Query(db database.DB, models ...*tests.User) *usersQueryBuilder {
	var queryModels []mapping.Model
	if len(models) > 0 {
		queryModels = make([]mapping.Model, len(models))
		for i, model := range models {
...
func (_u *NRN_Users) QueryCtx(ctx context.Context, db database.DB, models ...*tests.User) *usersQueryBuilder {
	var queryModels []mapping.Model
	if len(models) > 0 {
		queryModels = make([]mapping.Model, len(models))
		for i, model := range models {
