...
// NRN_CustomCars is the collection used to query Car model.
...
func (c *_CustomCars) ToModels(input ...*Car) []mapping.Model {
...
func (c *_CustomCars) FromModels(input ...mapping.Model) []*Car {
...
func (c *_CustomCars) Query(db database.DB, models ...*Car) *customCarsQueryBuilder {
...
func (c *_CustomCars) QueryCtx(ctx context.Context, db database.DB, models ...*Car) *customCarsQueryBuilder {
	var queryModels []mapping.Model
	if len(models) > 0 {
		queryModels = make([]mapping.Model, len(models))
		for i, model := range models {
...
func (c *_CustomCars) Insert(ctx context.Context, db database.DB, models ...*Car) error {
	if len(models) == 0 {
...
func (c *_CustomCars) Update(ctx context.Context, db database.DB, models ...*Car) (int64, error) {
	if len(models) == 0 {
...
func (c *_CustomCars) Delete(ctx context.Context, db database.DB, models ...*Car) (int64, error) {
	if len(models) == 0 {
		return 0, errors.Wrap(query.ErrNoModels, "nothing to insert")
	}
	queryModels := make([]mapping.Model, len(models))
...
func (c *_CustomCars) Refresh(ctx context.Context, db database.DB, models ...*Car) error {
	var queryModels []mapping.Model
	if len(models) == 0 {
...
func (c *customCarsQueryBuilder) Find() ([]*Car, error) {
	if c.err != nil {
		return nil, c.err
	}
...
func (c *customCarsQueryBuilder) Get() (*Car, error) {
	if c.err != nil {
		return nil, c.err
	}
