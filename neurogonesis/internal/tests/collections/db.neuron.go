...
func (_c *NRN_CustomCars) AddModels(ctx context.Context, db database.DB, model *tests.Car, relations ...*external.Models) error {
	if model == nil {
...
func (_c *NRN_CustomCars) GetModels(ctx context.Context, db database.DB, model *tests.Car, relationFieldset ...string) ([]*external.Models, error) {
	if model == nil {
	...
	if len(relationFieldset) == 0 {
		...
		for _, field := range relationFieldset {
			...
			if !ok {
				return nil, errors.Wrapf(mapping.ErrInvalidModelField, "no field: '%s' found for the model: 'external.Models'", field)
			}
	...
	if len(relations) == 0 {
		return []*external.Models{}, nil
	}
	result := make([]*external.Models, len(relations))
	for i, relation := range relations {
		result[i] = relation.(*external.Models)
	}
	return result, nil
}

// SetModels sets the 'Models' relationship for provided input 'models'.
func (_c *NRN_CustomCars) SetModels(ctx context.Context, db database.DB, model *tests.Car, relations ...*external.Models) error {
	if model == nil {
		return errors.Wrap(query.ErrNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
...
func (_c *NRN_CustomCars) AddNonPointerModels(ctx context.Context, db database.DB, model *tests.Car, relations ...*external.NonPointerModels) error {
	if model == nil {
		return errors.Wrap(query.ErrNoModels, "provided nil model")
	}
	if len(relations) == 0 {
...
func (_c *NRN_CustomCars) GetNonPointerModels(ctx context.Context, db database.DB, model *tests.Car, relationFieldset ...string) ([]*external.NonPointerModels, error) {
	if model == nil {
		return nil, errors.Wrap(query.ErrNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
	...
	if len(relationFieldset) == 0 {
		...
		for _, field := range relationFieldset {
			sField, ok := relationModel.FieldByName(field)
			if !ok {
				return nil, errors.Wrapf(mapping.ErrInvalidModelField, "no field: '%s' found for the model: 'external.NonPointerModels'", field)
			}
			fields = append(fields, sField)
		}
	}
	...
	if len(relations) == 0 {
		return []*external.NonPointerModels{}, nil
	}
	result := make([]*external.NonPointerModels, len(relations))
	for i, relation := range relations {
		result[i] = relation.(*external.NonPointerModels)
	}
	return result, nil
}

// SetNonPointerModels sets the 'NonPointerModels' relationship for provided input 'models'.
func (_c *NRN_CustomCars) SetNonPointerModels(ctx context.Context, db database.DB, model *tests.Car, relations ...*external.NonPointerModels) error {
	if model == nil {
		return errors.Wrap(query.ErrNoModels, "provided nil model")
	}
	// Check if primary key has zero value.
...
func (_c *_customCarsQueryBuilder) IncludeModels(modelsFieldset ...string) *_customCarsQueryBuilder {
	...
	for _, field := range modelsFieldset {
		...
		if !ok {
			_c.err = errors.Wrapf(mapping.ErrInvalidModelField, "field: '%s' is not found for the 'external.Models' model", field)
			return _c
		}
...
func (_c *_customCarsQueryBuilder) IncludeNonPointerModels(nonPointerModelsFieldset ...string) *_customCarsQueryBuilder {
	...
	for _, field := range nonPointerModelsFieldset {
		structField, ok := relation.Relationship().RelatedModelStruct().FieldByName(field)
		if !ok {
			_c.err = errors.Wrapf(mapping.ErrInvalidModelField, "field: '%s' is not found for the 'external.NonPointerModels' model", field)
			return _c
		}
		relationFields = append(relationFields, structField)
	}
...
func (_c *_customCarsQueryBuilder) AddModels(_models ...*external.Models) error {
	if _c.err != nil {
		return _c.err
	}
	relation, err := _c.builder.Scope().ModelStruct.RelationByIndex(6)
...
func (_c *_customCarsQueryBuilder) AddNonPointerModels(_nonPointerModels ...*external.NonPointerModels) error {
	if _c.err != nil {
		return _c.err
	}
	relation, err := _c.builder.Scope().ModelStruct.RelationByIndex(7)
...
func (_c *_customCarsQueryBuilder) SetModels(_models ...*external.Models) error {
	if _c.err != nil {
		return _c.err
	}
	relation, err := _c.builder.Scope().ModelStruct.RelationByIndex(6)
...
func (_c *_customCarsQueryBuilder) SetNonPointerModels(_nonPointerModels ...*external.NonPointerModels) error {
	if _c.err != nil {
		return _c.err
	}
	relation, err := _c.builder.Scope().ModelStruct.RelationByIndex(7)
...
func (_u *NRN_Users) modelStruct(_db database.DB) (*mapping.ModelStruct, error) {
	...
	mStruct, err := _db.ModelMap().ModelStruct(&tests.User{})
	if err != nil {
		return nil, err
	}
	_u.mStruct = mStruct
