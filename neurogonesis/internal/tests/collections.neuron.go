...
func (u *_Users) AddCars(ctx context.Context, db database.DB, model *User, relations ...*Car) error {
	...
	relationField, err := u.Model.RelationByIndex(12)
	if err != nil {
		return err
	}
...
func (u *_Users) ClearCarsRelation(ctx context.Context, db database.DB, models ...*User) (int64, error) {
	relation, err := u.Model.RelationByIndex(12)
	if err != nil {
		return 0, err
	}
	modelInterfaces := make([]mapping.Model, len(models))
...
func (u *_Users) AddSons(ctx context.Context, db database.DB, model *User, relations ...*User) error {
	...
	relationField, err := u.Model.RelationByIndex(13)
	if err != nil {
		return err
	}
	relationModels := make([]mapping.Model, len(relations))
...
func (u *_Users) ClearSonsRelation(ctx context.Context, db database.DB, models ...*User) (int64, error) {
	relation, err := u.Model.RelationByIndex(13)
	if err != nil {
		return 0, err
	}
	modelInterfaces := make([]mapping.Model, len(models))
...
func (u *usersQueryBuilder) IncludeCars(carsFieldset ...string) *usersQueryBuilder {
	...
	relation, err := NRN_Users.Model.RelationByIndex(12)
	if err != nil {
...
func (u *usersQueryBuilder) IncludeSons(sonsFieldset ...string) *usersQueryBuilder {
	...
	relation, err := NRN_Users.Model.RelationByIndex(13)
	if err != nil {
