...
func bindataTemplates04collectionbuildertmpl() (*asset, error) {
	...
	info := bindataFileInfo{
		...
		md5checksum: "",
		mode: os.FileMode(436),
		modTime: time.Unix(1598745232, 0),
	}
