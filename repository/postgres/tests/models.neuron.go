...
func (s *SimpleModel) GetPrimaryKeyStringValue() (string, error) {
	return "", errors.New(mapping.ClassModelDefinition, "model 'SimpleModel' has invalid primary key field type to parse string.")
}
...
func (o *OmitModel) GetPrimaryKeyStringValue() (string, error) {
	return "", errors.New(mapping.ClassModelDefinition, "model 'OmitModel' has invalid primary key field type to parse string.")
}
...
func (m *Model) GetPrimaryKeyStringValue() (string, error) {
	return "", errors.New(mapping.ClassModelDefinition, "model 'Model' has invalid primary key field type to parse string.")
}
