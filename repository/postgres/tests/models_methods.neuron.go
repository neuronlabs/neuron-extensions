...
// NeuronCollectionName implements mapping.Model interface method.
// Returns the name of the collection for the 'ForeignKeyModel'.
func (f *ForeignKeyModel) NeuronCollectionName() string {
	return "foreign_key_models"
}
