...
func (a *ArrModel) SetFrom(model mapping.Model) error {
	...
	if !ok {
		return errors.NewDetf(mapping.ClassModelNotMatch, "provided model doesn't match the input: %T", model)
	}
	*a = *from
	return nil
}
...
func (p *Pet) SetRelationModels(relation *mapping.StructField, models ...mapping.Model) error {
	...
	case 2: // Owners
		...
		p.Owners = temp
	default:
		return errors.Newf(mapping.ClassInvalidRelationField, "provided invalid relation: '%s' for the model 'Pet'", relation.String())
	}
	return nil
}
...
func (u *User) SetRelationModels(relation *mapping.StructField, models ...mapping.Model) error {
	...
	case 4: // Pets
		...
		u.Pets = temp
	default:
		return errors.Newf(mapping.ClassInvalidRelationField, "provided invalid relation: '%s' for the model 'User'", relation.String())
	}
	return nil
}
