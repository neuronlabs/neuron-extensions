...
func (a *ArrModel) SetPrimaryKeyValue(value interface{}) error {
	...
	case float64:
		a.ID = int(valueType)
	default:
		return errors.Wrapf(mapping.ErrFieldValue, "provided invalid value: '%T' for the primary field for model: 'ArrModel'", value)
	}
	return nil
}
...
func (a *ArrModel) SetFrom(model mapping.Model) error {
	if model == nil {
		return errors.Wrap(query.ErrInvalidInput, "provided nil model to set from")
	}
	from, ok := model.(*ArrModel)
	if !ok {
...
func (a *ArrModel) GetFieldsAddress(field *mapping.StructField) (interface{}, error) {
	...
	return nil, errors.Wrapf(mapping.ErrInvalidModelField, "provided invalid field: '%s' for given model: ArrModel'", field.Name())
}
...
func (a *ArrModel) SetFieldValue(field *mapping.StructField, value interface{}) (err error) {
	...
	case 1: // Arr
		...
		if generic, ok := value.([]interface{}); ok {
			if len(generic) > 2 {
				return errors.Wrapf(mapping.ErrFieldValue, "provided too many values for the field: 'Arr")
			}
		...
		return errors.Wrapf(mapping.ErrFieldValue, "provided invalid field type: '%T' for the field: %s", value, field.Name())
	default:
		return errors.Wrapf(mapping.ErrInvalidModelField, "provided invalid field: '%s' for the model: 'ArrModel'", field.Name())
	}
}
...
func (c *CustomTagModel) SetPrimaryKeyValue(value interface{}) error {
	...
	case float64:
		c.ID = int(valueType)
	default:
		return errors.Wrapf(mapping.ErrFieldValue, "provided invalid value: '%T' for the primary field for model: 'CustomTagModel'", value)
	}
	return nil
}
...
// SetFrom implements FromSetter interface.
func (c *CustomTagModel) SetFrom(model mapping.Model) error {
	if model == nil {
		return errors.Wrap(query.ErrInvalidInput, "provided nil model to set from")
	}
	from, ok := model.(*CustomTagModel)
	if !ok {
		return errors.WrapDetf(mapping.ErrModelNotMatch, "provided model doesn't match the input: %T", model)
	}
	*c = *from
...
func (c *CustomTagModel) SetFieldValue(field *mapping.StructField, value interface{}) (err error) {
	...
	case 4: // CustomOmitEmpty
		...
		return errors.Wrapf(mapping.ErrFieldValue, "provided invalid field type: '%T' for the field: %s", value, field.Name())
	default:
		return errors.Wrapf(mapping.ErrInvalidModelField, "provided invalid field: '%s' for the model: 'CustomTagModel'", field.Name())
	}
}
...
func (h *HiddenModel) SetPrimaryKeyValue(value interface{}) error {
	...
	case float64:
		h.ID = int(valueType)
	default:
		return errors.Wrapf(mapping.ErrFieldValue, "provided invalid value: '%T' for the primary field for model: 'HiddenModel'", value)
	}
	return nil
}
...
// SetFrom implements FromSetter interface.
func (h *HiddenModel) SetFrom(model mapping.Model) error {
	if model == nil {
		return errors.Wrap(query.ErrInvalidInput, "provided nil model to set from")
	}
	from, ok := model.(*HiddenModel)
	if !ok {
		return errors.WrapDetf(mapping.ErrModelNotMatch, "provided model doesn't match the input: %T", model)
	}
	*h = *from
...
func (h *HiddenModel) SetFieldValue(field *mapping.StructField, value interface{}) (err error) {
	...
	case 1: // Visible
		...
		// Check alternate types for the Visible.
		if v, ok := value.([]byte); ok {
			h.Visible = string(v)
			return nil
		}
	...
	case 2: // HiddenField
		...
		return errors.Wrapf(mapping.ErrFieldValue, "provided invalid field type: '%T' for the field: %s", value, field.Name())
	default:
		return errors.Wrapf(mapping.ErrInvalidModelField, "provided invalid field: '%s' for the model: 'HiddenModel'", field.Name())
	}
}
...
func (m *ModelPtrTime) SetPrimaryKeyValue(value interface{}) error {
	...
	case float64:
		m.ID = int(valueType)
	default:
		return errors.Wrapf(mapping.ErrFieldValue, "provided invalid value: '%T' for the primary field for model: 'ModelPtrTime'", value)
	}
	return nil
}
...
// SetFrom implements FromSetter interface.
func (m *ModelPtrTime) SetFrom(model mapping.Model) error {
	if model == nil {
		return errors.Wrap(query.ErrInvalidInput, "provided nil model to set from")
	}
	from, ok := model.(*ModelPtrTime)
	if !ok {
		return errors.WrapDetf(mapping.ErrModelNotMatch, "provided model doesn't match the input: %T", model)
	}
	*m = *from
...
func (m *ModelPtrTime) SetFieldValue(field *mapping.StructField, value interface{}) (err error) {
	...
	case 1: // Time
		...
		return errors.Wrapf(mapping.ErrFieldValue, "provided invalid field type: '%T' for the field: %s", value, field.Name())
	default:
		return errors.Wrapf(mapping.ErrInvalidModelField, "provided invalid field: '%s' for the model: 'ModelPtrTime'", field.Name())
	}
}
...
func (m *ModelPtrTime) ParseFieldsStringValue(field *mapping.StructField, value string) (interface{}, error) {
	...
	case 1: // Time
		...
		if err := temp.UnmarshalText([]byte(value)); err != nil {
			return "", errors.Wrapf(mapping.ErrFieldValue, "invalid field 'Time' value: '%v' to parse string. Err: %v", m.Time, err)
		}
...
func (m *ModelTime) SetPrimaryKeyValue(value interface{}) error {
	...
	case float64:
		m.ID = int(valueType)
	default:
		return errors.Wrapf(mapping.ErrFieldValue, "provided invalid value: '%T' for the primary field for model: 'ModelTime'", value)
	}
	return nil
}
...
// SetFrom implements FromSetter interface.
func (m *ModelTime) SetFrom(model mapping.Model) error {
	if model == nil {
		return errors.Wrap(query.ErrInvalidInput, "provided nil model to set from")
	}
	from, ok := model.(*ModelTime)
	if !ok {
		return errors.WrapDetf(mapping.ErrModelNotMatch, "provided model doesn't match the input: %T", model)
	}
	*m = *from
...
func (m *ModelTime) SetFieldValue(field *mapping.StructField, value interface{}) (err error) {
	...
	case 1: // Time
		...
		return errors.Wrapf(mapping.ErrFieldValue, "provided invalid field type: '%T' for the field: %s", value, field.Name())
	default:
		return errors.Wrapf(mapping.ErrInvalidModelField, "provided invalid field: '%s' for the model: 'ModelTime'", field.Name())
	}
}
...
func (p *Pet) AddRelationModel(relation *mapping.StructField, model mapping.Model) error {
	...
	case 2: // Owners
		user, ok := model.(*User)
		if !ok {
			return errors.Wrapf(mapping.ErrInvalidRelationValue, "provided invalid value type: '%T'  for the field: 'Owners'", model)
		}
		p.Owners = append(p.Owners, user)
	default:
		return errors.Wrapf(mapping.ErrInvalidRelationField, "provided invalid relation: '%T' for the model 'Pet'", model)
	}
	return nil
}
...
func (p *Pet) GetRelationModelAt(relation *mapping.StructField, index int) (models mapping.Model, err error) {
	...
	case 2: // Owners
		if index > len(p.Owners)-1 {
			return nil, errors.Wrapf(mapping.ErrInvalidRelationIndex, "index out of possible range. Model: 'Pet', Field Owners")
		}
...
// SetRelationModels implements mapping.MultiRelationer interface.
func (p *Pet) SetRelationModels(relation *mapping.StructField, models ...mapping.Model) error {
	switch relation.Index[0] {
	case 2: // Owners
		...
		p.Owners = temp
	default:
		return errors.Wrapf(mapping.ErrInvalidRelationField, "provided invalid relation: '%s' for the model 'Pet'", relation.String())
	}
	return nil
}
...
// SetFrom implements FromSetter interface.
func (u *UnmarshalModel) SetFrom(model mapping.Model) error {
	if model == nil {
		return errors.Wrap(query.ErrInvalidInput, "provided nil model to set from")
	}
	from, ok := model.(*UnmarshalModel)
	if !ok {
		return errors.WrapDetf(mapping.ErrModelNotMatch, "provided model doesn't match the input: %T", model)
	}
	*u = *from
...
func (u *UnmarshalModel) SetFieldValue(field *mapping.StructField, value interface{}) (err error) {
	...
	case 3: // StringSlice
		...
		return errors.Wrapf(mapping.ErrFieldValue, "provided invalid field type: '%T' for the field: %s", value, field.Name())
	default:
		return errors.Wrapf(mapping.ErrInvalidModelField, "provided invalid field: '%s' for the model: 'UnmarshalModel'", field.Name())
	}
}
...
func (u *UnmarshalModel) ParseFieldsStringValue(field *mapping.StructField, value string) (interface{}, error) {
	...
	case 2: // PtrTime
		...
		temp := &base
		if err := temp.UnmarshalText([]byte(value)); err != nil {
			return "", errors.Wrapf(mapping.ErrFieldValue, "invalid field 'PtrTime' value: '%v' to parse string. Err: %v", u.PtrTime, err)
		}
		bt, err := temp.MarshalText()
		if err != nil {
			return "", errors.Wrapf(mapping.ErrFieldValue, "invalid field 'PtrTime' value: '%v' to parse string. Err: %v", u.PtrTime, err)
...
func (u *UserPets) SetPrimaryKeyValue(value interface{}) error {
	...
	case float64:
		u.ID = int(valueType)
	default:
		return errors.Wrapf(mapping.ErrFieldValue, "provided invalid value: '%T' for the primary field for model: 'UserPets'", value)
	}
	return nil
}
...
// SetFrom implements FromSetter interface.
func (u *UserPets) SetFrom(model mapping.Model) error {
	if model == nil {
		return errors.Wrap(query.ErrInvalidInput, "provided nil model to set from")
	}
	from, ok := model.(*UserPets)
	if !ok {
		return errors.WrapDetf(mapping.ErrModelNotMatch, "provided model doesn't match the input: %T", model)
	}
	*u = *from
...
func (u *UserPets) GetFieldsAddress(field *mapping.StructField) (interface{}, error) {
	...
	return nil, errors.Wrapf(mapping.ErrInvalidModelField, "provided invalid field: '%s' for given model: UserPets'", field.Name())
}
...
func (u *UserPets) SetFieldValue(field *mapping.StructField, value interface{}) (err error) {
	...
	case 2: // UserID
		...
		return nil
	default:
		return errors.Wrapf(mapping.ErrInvalidModelField, "provided invalid field: '%s' for the model: 'UserPets'", field.Name())
	}
}
